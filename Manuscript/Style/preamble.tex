...
\newcommand{\keywords}{Uncertainty; Monte Carlo Simulation; Importance Sampling; Markov Chain Monte Carlo; Community Resilience; Disaster; Natural Hazards; Hazard Scenarios.}
...
\newcommand{\MCResult}{0.089}
\newcommand{\TraditionalISResult}{0.075}
\newcommand{\MCMCISResult}{0.079}

\newcommand{\MCError}{1.213}
\newcommand{\TraditionalISError}{0.689}
\newcommand{\MCMCISError}{0.028}

\newcommand{\MCSEM}{0.022}
\newcommand{\TraditionalISSEM}{0.012}
\newcommand{\MCMCISSEM}{0.000}
